...
type S3API interface {
	...
	ReplicateOneObject(*s3.ReplicateOneObjectInput) (*s3.ReplicateOneObjectOutput, error)
	ReplicateOneObjectWithContext(aws.Context, *s3.ReplicateOneObjectInput, ...request.Option) (*s3.ReplicateOneObjectOutput, error)
	ReplicateOneObjectRequest(*s3.ReplicateOneObjectInput) (*request.Request, *s3.ReplicateOneObjectOutput)
