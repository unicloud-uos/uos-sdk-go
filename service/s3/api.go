...
const opReplicateOneObject = "ReplicateOneObject"

// ReplicateOneObjectRequest generates a "aws/request.Request" representing the
// client's request for the ReplicateOneObject operation. The "output" return
// value will be populated with the request's response once the request completes
// successfully.
//
// Use "Send" method on the returned Request to send the API call to the service.
// the "output" return value is not valid until after Send returns without error.
//
// See ReplicateOneObject for more information on using the ReplicateOneObject
// API call, and error handling.
//
// This method is useful when you want to inject custom logic or configuration
// into the SDK's request lifecycle. Such as custom headers, or retry logic.
//
//
//    // Example sending a request using the ReplicateOneObjectRequest method.
//    req, resp := client.ReplicateOneObjectRequest(params)
//
//    err := req.Send()
//    if err == nil { // resp is now filled
//        fmt.Println(resp)
//    }
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/s3-2006-03-01/ReplicateOneObject
func (c *S3) ReplicateOneObjectRequest(input *ReplicateOneObjectInput) (req *request.Request, output *ReplicateOneObjectOutput) {
	op := &request.Operation{
		Name:       opReplicateOneObject,
		HTTPMethod: "PUT",
		HTTPPath:   "/{Bucket}/{Key+}?replication",
	}

	if input == nil {
		input = &ReplicateOneObjectInput{}
	}

	output = &ReplicateOneObjectOutput{}
	req = c.newRequest(op, input, output)
	req.Handlers.Unmarshal.Swap(restxml.UnmarshalHandler.Name, protocol.UnmarshalDiscardBodyHandler)
	return
}

// ReplicateOneObject API operation for Amazon Simple Storage Service.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
//
// See the AWS API reference guide for Amazon Simple Storage Service's
// API operation ReplicateOneObject for usage and error information.
// See also, https://docs.aws.amazon.com/goto/WebAPI/s3-2006-03-01/ReplicateOneObject
func (c *S3) ReplicateOneObject(input *ReplicateOneObjectInput) (*ReplicateOneObjectOutput, error) {
	req, out := c.ReplicateOneObjectRequest(input)
	return out, req.Send()
}

// ReplicateOneObjectWithContext is the same as ReplicateOneObject with the addition of
// the ability to pass a context and additional request options.
//
// See ReplicateOneObject for details on how to use this API operation.
//
// The context must be non-nil and will be used for request cancellation. If
// the context is nil a panic will occur. In the future the SDK may create
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *S3) ReplicateOneObjectWithContext(ctx aws.Context, input *ReplicateOneObjectInput, opts ...request.Option) (*ReplicateOneObjectOutput, error) {
	req, out := c.ReplicateOneObjectRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type HttpConfiguration struct {
	...
	// HttpEndPoint is a required field
	HttpEndPoint []*string `locationName:"HttpEndPoint" type:"list" flattened:"true" required:"true"`
...
func (s *HttpConfiguration) Validate() error {
	...
	if s.HttpEndPoint == nil {
		invalidParams.Add(request.NewErrParamRequired("HttpEndPoint"))
	}
...
// SetEvents sets the Events field's value.
func (s *HttpConfiguration) SetEvents(v []*string) *HttpConfiguration {
	s.Events = v
	return s
}

// SetFilter sets the Filter field's value.
func (s *HttpConfiguration) SetFilter(v *NotificationConfigurationFilter) *HttpConfiguration {
	s.Filter = v
	return s
}

// SetHttpEndPoint sets the HttpEndPoint field's value.
func (s *HttpConfiguration) SetHttpEndPoint(v []*string) *HttpConfiguration {
	s.HttpEndPoint = v
	return s
}

// SetId sets the Id field's value.
func (s *HttpConfiguration) SetId(v string) *HttpConfiguration {
	s.Id = &v
	return s
}
...
type NotificationConfiguration struct {
	...
	HttpConfigurations []*HttpConfiguration `locationName:"HttpConfiguration" type:"list" flattened:"true"`
...
func (s *NotificationConfiguration) Validate() error {
	...
	if s.HttpConfigurations != nil {
		for i, v := range s.HttpConfigurations {
			if v == nil {
				continue
			}
			if err := v.Validate(); err != nil {
				invalidParams.AddNested(fmt.Sprintf("%s[%v]", "HttpConfigurations", i), err.(request.ErrInvalidParams))
			}
		}
	}
...
// SetHttpConfigurations sets the HttpConfigurations field's value.
func (s *NotificationConfiguration) SetHttpConfigurations(v []*HttpConfiguration) *NotificationConfiguration {
	s.HttpConfigurations = v
	return s
}
...
type ReplicateOneObjectInput struct {
	_ struct{} `type:"structure" payload:"ReplicationConfiguration"`
...
// String returns the string representation
func (s ReplicateOneObjectInput) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s ReplicateOneObjectInput) GoString() string {
	return s.String()
}

// Validate inspects the fields of the type to determine if they are valid.
func (s *ReplicateOneObjectInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "ReplicateOneObjectInput"}
	if s.Bucket == nil {
		invalidParams.Add(request.NewErrParamRequired("Bucket"))
	}
	if s.Bucket != nil && len(*s.Bucket) < 1 {
...
// SetBucket sets the Bucket field's value.
func (s *ReplicateOneObjectInput) SetBucket(v string) *ReplicateOneObjectInput {
	s.Bucket = &v
	return s
}

func (s *ReplicateOneObjectInput) getBucket() (v string) {
	if s.Bucket == nil {
		return v
	}
	return *s.Bucket
...
// SetKey sets the Key field's value.
func (s *ReplicateOneObjectInput) SetKey(v string) *ReplicateOneObjectInput {
	s.Key = &v
	return s
}

// SetReplicationConfiguration sets the ReplicationConfiguration field's value.
func (s *ReplicateOneObjectInput) SetReplicationConfiguration(v *ReplicationConfiguration) *ReplicateOneObjectInput {
	s.ReplicationConfiguration = v
	return s
}

type ReplicateOneObjectOutput struct {
	_ struct{} `type:"structure"`
}

// String returns the string representation
func (s ReplicateOneObjectOutput) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s ReplicateOneObjectOutput) GoString() string {
	return s.String()
}
